...
// New comment functionality added below this line
...
function loadDatabase() {
  try {
    let doc = yaml.safeLoad(fs.readFileSync('scoopDatabase.yml', 'utf8'));
    return doc;
  } catch (e) {
    console.log(e);
  }
...
function saveDatabase() {
  try {
    fs.writeFileSync('scoopDatabase.yml', yaml.safeDump(database), 'utf8');
  } catch (e) {
    console.log(e);
  }
}
